...
# with command line options: step1 --filein file:test_aod.root --fileout file:test_miniaod.root --mc --eventcontent MINIAODSIM --runUnscheduled --datatier MINIAODSIM --conditions 94X_mc2017_realistic_v14 --step PAT --nThreads 4 --scenario pp --era Run2_2017,run2_miniAOD_94XFall17 --python_filename run_miniaod.py --no_exec --customise Configuration/DataProcessing/Utils.addMonitoring -n 100
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:test_aod.root'),
